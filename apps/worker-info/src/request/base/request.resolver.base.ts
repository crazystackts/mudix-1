...
export class RequestResolverBase {
  ...
  @graphql.ResolveField(() => [Dependent], { name: "dependents" })
  async findDependents(
    @graphql.Parent() parent: Request,
    @graphql.Args() args: DependentFindManyArgs
  ): Promise<Dependent[]> {
    const results = await this.service.findDependents(parent.id, args);
  ...
  @graphql.ResolveField(() => [Holder], { name: "holder" })
  async findHolder(
    @graphql.Parent() parent: Request,
    @graphql.Args() args: HolderFindManyArgs
  ): Promise<Holder[]> {
    const results = await this.service.findHolder(parent.id, args);
  ...
  async getWorker(@graphql.Parent() parent: Request): Promise<Worker | null> {
