...
@InputType()
class DependentCreateNestedManyWithoutRequestsInput {
...
export { DependentCreateNestedManyWithoutRequestsInput as DependentCreateNestedManyWithoutRequestsInput };
