...
@InputType()
class AttachmentCreateNestedManyWithoutHoldersInput {
...
export { AttachmentCreateNestedManyWithoutHoldersInput as AttachmentCreateNestedManyWithoutHoldersInput };
