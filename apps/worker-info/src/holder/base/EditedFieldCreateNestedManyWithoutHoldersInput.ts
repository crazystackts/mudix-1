...
@InputType()
class EditedFieldCreateNestedManyWithoutHoldersInput {
...
export { EditedFieldCreateNestedManyWithoutHoldersInput as EditedFieldCreateNestedManyWithoutHoldersInput };
