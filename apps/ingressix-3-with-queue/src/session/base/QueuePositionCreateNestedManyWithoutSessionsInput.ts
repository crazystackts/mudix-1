...
@InputType()
class QueuePositionCreateNestedManyWithoutSessionsInput {
...
export { QueuePositionCreateNestedManyWithoutSessionsInput as QueuePositionCreateNestedManyWithoutSessionsInput };
