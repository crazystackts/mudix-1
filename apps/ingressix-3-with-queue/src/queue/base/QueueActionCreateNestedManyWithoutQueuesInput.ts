...
@InputType()
class QueueActionCreateNestedManyWithoutQueuesInput {
...
export { QueueActionCreateNestedManyWithoutQueuesInput as QueueActionCreateNestedManyWithoutQueuesInput };
