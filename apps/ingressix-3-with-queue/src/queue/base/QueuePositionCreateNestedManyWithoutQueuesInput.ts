...
@InputType()
class QueuePositionCreateNestedManyWithoutQueuesInput {
...
export { QueuePositionCreateNestedManyWithoutQueuesInput as QueuePositionCreateNestedManyWithoutQueuesInput };
