...
export class OrderResolverBase {
  ...
  @graphql.ResolveField(() => [PaymentHistory], { name: "paymentHistory" })
  async findPaymentHistory(
    @graphql.Parent() parent: Order,
    @graphql.Args() args: PaymentHistoryFindManyArgs
  ): Promise<PaymentHistory[]> {
    const results = await this.service.findPaymentHistory(parent.id, args);
  ...
  async getSessions(@graphql.Parent() parent: Order): Promise<Session | null> {
