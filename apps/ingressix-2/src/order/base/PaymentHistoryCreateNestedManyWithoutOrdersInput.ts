...
@InputType()
class PaymentHistoryCreateNestedManyWithoutOrdersInput {
...
export { PaymentHistoryCreateNestedManyWithoutOrdersInput as PaymentHistoryCreateNestedManyWithoutOrdersInput };
